...
export default class BakerOrderList extends Component{
  constructor(props){
    /*Props: storeID: ID of current store to check*/
    super(props);
    this.state = {
  ...
  render(){
    console.log("Current StoreID: " + this.props.storeID);
 ...
 // show Loading while we are waiting
    ...
    {
      if(orderInfo == null){ //If null, do nothing.
    ...
    filterOrder(){
      ...
      this.fetchData(GLOBAL.BASE_URL + "/stores/" + this.props.storeID + "/transactions/", filterValue);
    }
    ...
    componentDidMount()
    {
        ...
        this.fetchData(GLOBAL.BASE_URL + "/stores/" + this.props.storeID + "/transactions/",  this.state.timeFilter);
    }
